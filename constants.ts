  ...
  en: {
    ...
    experience: {
      ...
      items: [
        ...
        {
          company: "Saf Communications",
          role: "Market Development Manager",
          period: "2006 - 2007",
          description: [
            "Active in ERP solutions for the heavy automotive industry.",
            "Implementation of Digital Signature solutions."
          ]
        },
        {
  ...
  fa: {
    ...
    experience: {
      ...
      items: [
        ...
        {
          company: "شرکت ارتباطات صف",
          role: "مدیر توسعه بازار",
          period: "۱۳۸۵ - ۱۳۸۶",
          description: [
            "فعالیت در حوزه ERP در صنعت خودرو سنگین",
            "فعالیت در حوزه امضا دیجیتال"
          ]
        },
        {
